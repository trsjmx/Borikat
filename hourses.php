...
<div class="section1">
        <img src="images2\hourse.png" alt="header" class="image1">
        <h2>مرابط الخيل</h2>
        <p>رحلة ممتعة في عالم الفروسية</p>
    </div>
    ...
    <ul class="section2">
        ...
        <li class="section2_item">
          <a href="" class="section2_link section2_link--active"> مرابط خيل</a>
        </li>
      </ul>
...
<div class="container">
   ...
   <div class="section3-content">
    <img src="images2\hourse1.png" alt="museum1" class="section3-image" />
    ...
    <div class="section3">
        <h3> مربط البراء</h3>
        <p>مربط خيل نسائي</p>
        <a href="hoursesInfo.php" class="read-more">
